...
public class LionIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lion_iactivity);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LionIActivity.this,MainActivity.class);
        ...
        chatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LionIActivity.this,ChatbotActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(LionIActivity.this);
        ...
        alertDialog.setSingleChoiceItems(listItems, checkedItem[0], new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    information.setText(R.string.kidslion);
                ...
                {
                    information.setText(R.string.adultslion);
                    floatingActionButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            floatingActionButton.setEnabled(false);

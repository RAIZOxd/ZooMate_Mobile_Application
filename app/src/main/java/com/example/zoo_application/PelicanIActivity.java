...
public class PelicanIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pelican_iactivity);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PelicanIActivity.this,MainActivity.class);
        ...
        chatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PelicanIActivity.this,ChatbotActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PelicanIActivity.this);
        ...
        alertDialog.setSingleChoiceItems(listItems, checkedItem[0], new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    information.setText(R.string.kidspelican);
                ...
                {
                    information.setText(R.string.adultspelican);
                    floatingActionButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            floatingActionButton.setEnabled(false);

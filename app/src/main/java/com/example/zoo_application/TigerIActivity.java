...
public class TigerIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiger_iactivity);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TigerIActivity.this,MainActivity.class);
        ...
        chatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TigerIActivity.this,ChatbotActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(TigerIActivity.this);
        ...
        alertDialog.setSingleChoiceItems(listItems, checkedItem[0], new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    information.setText(R.string.kidstiger);
                ...
                {
                    information.setText(R.string.adultstiger);
                    floatingActionButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            floatingActionButton.setEnabled(false);

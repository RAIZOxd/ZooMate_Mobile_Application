...
public class DeerIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deer_iactivity);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DeerIActivity.this,MainActivity.class);
        ...
        chatbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DeerIActivity.this,ChatbotActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeerIActivity.this);
        ...
        alertDialog.setSingleChoiceItems(listItems, checkedItem[0], new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    information.setText(R.string.kidsdeer);
                ...
                {
                    information.setText(R.string.adultsdeer);
                    floatingActionButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            floatingActionButton.setEnabled(false);
